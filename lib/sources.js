...
export const SOURCES = [
  ...
  { id: 'point', name: 'Point.md', url: 'https://point.md/ro/rss', region: 'moldova' },
  { id: 'tvn', name: 'TVN.md', url: 'https://tvn.md/feed', region: 'moldova' },
  ...
  },
  {
    ...
    region: 'moldova',
    tip: 'html',
    pagina: 'https://tvrmoldova.md/',
    selectorArticol: '.post-title a[href*="/article/"]',
  },
  {
